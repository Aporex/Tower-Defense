...
public class EffectTank extends Effect {
	...
	public EffectTank(GameState state, Point origin, Point dest) {
	...
	public void draw(Graphics g) {
		...
		g.drawImage(ResourceLoader.getLoader().getImage("MortarSHell.png"), (int) x, (int) y, 30, 15, null);
